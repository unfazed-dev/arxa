...
class StackedRouterWeb extends _i10.RootStackRouter {
  ...
  List<_i10.RouteConfig> get routes => [
    _i10.RouteConfig(PairingScanViewRoute.name, path: '/'),
    _i10.RouteConfig(
    ...
    _i10.RouteConfig(StudioSessionViewRoute.name, path: '/studio-session-view'),
    _i10.RouteConfig(ApprovalsListViewRoute.name, path: '/approvals-list-view'),
    _i10.RouteConfig(SettingsHomeViewRoute.name, path: '/settings-home-view'),
    _i10.RouteConfig(CodeSessionsViewRoute.name, path: '/code-sessions-view'),
    _i10.RouteConfig(
...
class CodeConversationViewRoute
  ...
  CodeConversationViewRoute({required String sessionId, _i11.Key? key})
    : super(
        CodeConversationViewRoute.name,
        path: '/code-conversation-view',
        args: CodeConversationViewArgs(sessionId: sessionId, key: key),
      );
...
class CodeConversationViewArgs {
  const CodeConversationViewArgs({required this.sessionId, this.key});
...
extension RouterStateExtension on _i9.RouterService {
  Future<dynamic> navigateToPairingScanView({
    ...
    return navigateTo(PairingScanViewRoute(key: key), onFailure: onFailure);
  }
  ...
  Future<dynamic> navigateToPairingConnectingView({
    ...
    return navigateTo(
      PairingConnectingViewRoute(key: key),
      onFailure: onFailure,
    );
  }
  ...
  Future<dynamic> navigateToPairingPushPermissionView({
    ...
    return navigateTo(
      PairingPushPermissionViewRoute(key: key),
      onFailure: onFailure,
    );
  }
  ...
  Future<dynamic> navigateToStudioSessionView({
    ...
    return navigateTo(StudioSessionViewRoute(key: key), onFailure: onFailure);
  }
  ...
  Future<dynamic> navigateToApprovalsListView({
    ...
    return navigateTo(ApprovalsListViewRoute(key: key), onFailure: onFailure);
  }
  ...
  Future<dynamic> navigateToSettingsHomeView({
    ...
    return navigateTo(SettingsHomeViewRoute(key: key), onFailure: onFailure);
  }
  ...
  Future<dynamic> navigateToCodeSessionsView({
    ...
    return navigateTo(CodeSessionsViewRoute(key: key), onFailure: onFailure);
  }
  ...
  Future<dynamic> navigateToCodeConversationView({
    ...
    return navigateTo(
      CodeConversationViewRoute(sessionId: sessionId, key: key),
      onFailure: onFailure,
    );
  }
  ...
  Future<dynamic> replaceWithPairingScanView({
    ...
    return replaceWith(PairingScanViewRoute(key: key), onFailure: onFailure);
  }
  ...
  Future<dynamic> replaceWithStudioSessionView({
    ...
    return replaceWith(StudioSessionViewRoute(key: key), onFailure: onFailure);
  }
  ...
  Future<dynamic> replaceWithApprovalsListView({
    ...
    return replaceWith(ApprovalsListViewRoute(key: key), onFailure: onFailure);
  }
  ...
  Future<dynamic> replaceWithSettingsHomeView({
    ...
    return replaceWith(SettingsHomeViewRoute(key: key), onFailure: onFailure);
  }
  ...
  Future<dynamic> replaceWithCodeSessionsView({
    ...
    return replaceWith(CodeSessionsViewRoute(key: key), onFailure: onFailure);
  }
