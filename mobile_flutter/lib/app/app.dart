...
@StackedApp(
  ...
  dependencies: [
    ...
    // The iroh-backed transport replaces the fake behind the same interface
    // (clean seam — the real one arrives from another workstream).
    LazySingleton(classType: FakeTransportService, asType: TransportService),
