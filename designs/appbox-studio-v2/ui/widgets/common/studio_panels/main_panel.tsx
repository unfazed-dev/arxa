// main_panel.tsx — the Main Panel: the center stage region, the single render
// destination for all content, plus the per-shell panel bar and the file viewer.
// Replaces the v1 main panel markup.
import { raw } from 'hono/utils/html';
import type { Child } from 'hono/jsx';
import Icon from '../../../../runtime/icon.tsx';
import { inspectAttrs } from '../studio_primitives/primitives.tsx';
...
// children directly. The original also interpolated a raw `spec.attributes`
...
// Picks the mode's body from the server-chosen file.mode.
