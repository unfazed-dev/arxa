...
export function Header(props: HeaderProps) {
  ...
  return (
    <Fragment>
      <details class="shell-drawer shell-hub-touch" {...inspectAttributes('studio_hub:drawer', { role: 'nav' })}>
      ...
      <a class="shell-brand" href="/" {...inspectAttributes('studio_hub:brand', { role: 'link' })}>appbox studio</a>

      {project && (
        <a class="shell-project" href="/" title={translate('hub.projectBack') as string} {...inspectAttributes('studio_hub:project', { role: 'link' })}>
      ...
      <span class="shell-links" {...inspectAttributes('studio_hub:links', { role: 'nav' })}>
        {shellDestinations.map((destination) => (
          <a
            key={destination.id}
      ...
      <span class="channel" title={translate('hub.daemonChannel') as string} {...inspectAttributes('studio_hub:channel', { role: 'status' })}>
        <span class="channel-dot"></span>
        <span class="channel-label">{translate('hub.daemonLive') as string}</span>
      </span>
      ...
      <details class="shell-overflow shell-hub-touch" {...inspectAttributes('studio_hub:overflow', { role: 'nav' })}>
