// Role: the brief step surface at the medium rung. The step stages are
...
// History: git log --follow -- ui/views/studio_intake_shell/studio_intake_brief/studio_intake_brief_view.tablet.tsx
