// Role: the surfaces step surface at the compact rung. The step stages are
...
// History: git log --follow -- ui/views/studio_intake_shell/studio_intake_surfaces/studio_intake_surfaces_view.mobile.tsx
