// Role: the personas step surface at the medium rung. The step stages are
...
// History: git log --follow -- ui/views/studio_intake_shell/studio_intake_personas/studio_intake_personas_view.tablet.tsx
