// Role: the interview step surface at the compact rung. The step stages are
...
// History: git log --follow -- ui/views/studio_intake_shell/studio_intake_interview/studio_intake_interview_view.mobile.tsx
