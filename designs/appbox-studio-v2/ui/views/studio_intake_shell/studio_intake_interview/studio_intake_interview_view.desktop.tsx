// Role: the interview step surface at the expanded rung. The step stages are
...
// Requirements: Q-v2-3.
// Relationships: mounted by studio_intake_interview_view.tsx (single-render law).
// History: git log --follow -- ui/views/studio_intake_shell/studio_intake_interview/studio_intake_interview_view.desktop.tsx
