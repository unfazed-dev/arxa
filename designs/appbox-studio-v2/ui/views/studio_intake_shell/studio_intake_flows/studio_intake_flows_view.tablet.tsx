// Role: the flows step surface at the medium rung. The step stages are
...
// History: git log --follow -- ui/views/studio_intake_shell/studio_intake_flows/studio_intake_flows_view.tablet.tsx
