...
//   as boot steps land.
// Requirements: Q-v2-3 (desktop/tablet/mobile for every studio view), Q-v2-5
//   (inspect triple: data-inspect-view | -surface | -widget).
...
export const Progress: FC<StartupProps> = ({ steps, ready }) => (
