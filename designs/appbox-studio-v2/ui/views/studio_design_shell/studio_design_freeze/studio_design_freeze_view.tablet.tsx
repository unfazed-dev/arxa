// Role: the freeze design surface at the medium rung. Run-invariant by the
...
// History: git log --follow -- ui/views/studio_design_shell/studio_design_freeze/studio_design_freeze_view.tablet.tsx
