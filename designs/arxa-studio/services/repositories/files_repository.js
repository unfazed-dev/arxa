...
const FILES = {
  ...
  // design seed list
  'designs/arxa-studio/models/design_model/design_seed.en.json': { body: DESIGN_SEED_JSON },
  'designs/arxa-studio/models/design_model/run.json': { body: RUN_JSON },
