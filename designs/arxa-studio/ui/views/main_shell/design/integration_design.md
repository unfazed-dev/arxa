...
## 1. Routes — `designs/arxa-studio/app.routes.js`
...
## 2. Stylesheet — `designs/arxa-studio/ui/common/base.html`

Already links `design.css` and `viewer.css` — no change needed.

## 3. Shell nav (optional) — `designs/arxa-studio/ui/views/main_shell/main_shell_view.html`
