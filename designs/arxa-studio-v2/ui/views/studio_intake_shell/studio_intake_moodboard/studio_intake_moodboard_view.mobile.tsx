// Role: the moodboard step surface at the compact rung. The step stages are
...
// History: git log --follow -- ui/views/studio_intake_shell/studio_intake_moodboard/studio_intake_moodboard_view.mobile.tsx
