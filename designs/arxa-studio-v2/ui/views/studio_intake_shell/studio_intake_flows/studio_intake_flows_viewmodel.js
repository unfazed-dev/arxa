...
export const surfaceId = 'studio_intake_flows';

import * as facade from '../../../../services/studio_intake_services/facades/studio_intake_facade_service.js';

const VIEW = 'ui/views/studio_intake_shell/studio_intake_flows/studio_intake_flows_view.html';
const SURFACE = 'flows';
...
export const acceptAll = async (context, helpers) => {
  ...
  return helpers.render(context, `${VIEW}#panelsSwap`, facade.acceptAll(helpers.session(context).data, SURFACE, helpers.prefs(context), helpers.translate(context), helpers.locale(context)));
};
