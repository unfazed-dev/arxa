// Role: the direction step surface at the medium rung. The step stages are
...
// History: git log --follow -- ui/views/studio_intake_shell/studio_intake_direction/studio_intake_direction_view.tablet.tsx
