// Role: the mapping step surface at the compact rung. The step stages are
...
// History: git log --follow -- ui/views/studio_intake_shell/studio_intake_mapping/studio_intake_mapping_view.mobile.tsx
