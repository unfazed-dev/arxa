...
// Source: designs/arxa-studio/l10n/app_en.arb (subset by prefix).
...
const STRINGS: Record<string, string> = {
  ...
  "dash.pageTitle": "Arxa Studio — Dashboard",
  ...
  "auth.pageTitle": "Arxa Studio — Sign in",
  "auth.email": "Email",
  "auth.continue": "Continue",
  "auth.createAccount": "Create account",
  "auth.or": "or",
  "splash.connecting": "Connecting to the arxa daemon",
