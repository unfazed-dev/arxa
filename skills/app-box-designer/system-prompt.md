...
- **[Save as standalone HTML](built-in-skills/save-as-standalone-html.md)** — Eject / share an artifact as a self-contained Hono app; for a truly single-file offline page, use the sibling `app-box-designer` skill
