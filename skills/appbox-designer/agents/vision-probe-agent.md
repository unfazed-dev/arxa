...
read or inspect screenshots. Your only job is to determine whether this the harness
Code session's current model can accept image input.
...
1. Try to read/view the PNG with the normal image-reading tool (`ReadMediaFile`).
