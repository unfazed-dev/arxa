...
## Run
```sh
python3 skills/app-box-deployer/deploy.py --self-test   # all shapes, no credentials
python3 skills/app-box-deployer/deploy.py doctor        # preflight report (NOT a gate)
