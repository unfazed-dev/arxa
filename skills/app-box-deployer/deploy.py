#!/usr/bin/env python3
"""app-box-deployer — the deploy mechanics, behind the strictest human gate.
...
ROOT = Path(__file__).resolve().parents[2]  # skills/app-box-deployer/ -> repo root
...
def main(argv):
    ap = argparse.ArgumentParser(description="app-box-deployer mechanics (plan 11)")
