...
protection, and runner setup. Generic over any project; for arxa-built
targets it wires `arxa gate --all` instead of inventing checks.
...
(before intake), wrapping ALL gates (`arxa gate --all`); the tail —
...
Distilled from the t3ci bundle (arxa CI bootstrap + Theo/t3.gg video
