...
- The HTML view that embeds the images is the recorded asset (`arxa design record-asset`); the raster files themselves are ordinary project files referenced by it — not separately recorded.
