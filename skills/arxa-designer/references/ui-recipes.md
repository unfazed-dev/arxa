...
**Flutter:** ArxaKitNativeButton, ArxaKitNativeSplitButton; ArxaKitNativeIconButton for icon-only.
...
Flutter: ArxaKitListTile trailing chevron / ArxaKitNativeButton(link).
...
**Flutter:** ArxaKitGlyphs (core kit).
...
**Flutter:** ArxaKitNativeNavigationRail; ArxaKitDrawer for the compact drawer form.
...
**Flutter:** ArxaKitAnimatedTabStack (+ ArxaKitDirectionalTabTransition,
ArxaKitNativeTabBar for the bar alone).
...
**Flutter:** ArxaKitBottomNavScaffold.
...
**Flutter:** ArxaKitNativeAppBar; ArxaKitNativeSliverAppBar (collapsing),
ArxaKitNativeToolbar (desktop).
...
**Flutter:** ArxaKitChip; ArxaKitChipCarousel for the scrolling row.
...
**Flutter:** ArxaKitNativeTextField + ArxaKitFieldController (forms kit).
...
**Flutter:** ArxaKitNativeSearchBar.
...
**Flutter:** ui_library sheet/dialog services; ArxaKitNativePopupMenu for menus.
...
**Flutter:** ArxaKitNotificationService.show.
...
**Flutter:** none — compose ArxaKitListTile at compact density, or custom.
...
**Flutter:** none — compose icon + copy + ArxaKitNativeButton.
...
**Flutter:** ArxaKitNativeLoadingIndicator, ArxaKitNativeProgress;
ArxaKitLazyIndexedStack for the deferred-pane case.
...
**Flutter:** ArxaKitLazyIndexedStack.
...
(canon: `designs/arxa-studio/ui/common/_integration_panels.md`):
...
|---|---|---|
| Buttons & action rows | `_cta-link.tsx` (navigational variant) | ArxaKitNativeButton, ArxaKitNativeIconButton, ArxaKitNativeSplitButton |
| Icon | — (`runtime/icon.tsx` component) | ArxaKitGlyphs (core) |
| Nav rail (railbar) | `_nav-rail.tsx` | ArxaKitNativeNavigationRail; ArxaKitDrawer (drawer form) |
| Tabs | `_tabs.tsx` | ArxaKitAnimatedTabStack, ArxaKitDirectionalTabTransition, ArxaKitNativeTabBar |
| Tabbar | `_tabbar.tsx` | ArxaKitBottomNavScaffold |
| App bar / toolbar | `_appbar.tsx` | ArxaKitNativeAppBar, ArxaKitNativeSliverAppBar, ArxaKitNativeToolbar |
| List rows & sections | `_list-row.tsx` | ArxaKitListTile, ArxaKitListSection |
| Card | `_card.tsx` | ArxaKitGlassCard, ArxaKitFrostedSurface |
| Chip | — (component) | ArxaKitChip, ArxaKitChipCarousel |
| Form fields + 422 | `_form-field.tsx` | ArxaKitNativeTextField + ArxaKitFieldController (forms kit) |
| Search / filter | — (component) | ArxaKitNativeSearchBar |
| Dialog / popover | `_dialog.tsx` (server-driven), `_modal.tsx` (declarative) | ui_library sheet/dialog services; ArxaKitNativePopupMenu |
| Bottom sheet | `_bottom-sheet.tsx` | ui_library sheet service |
| Toast | `_toast.tsx` | ArxaKitNotificationService.show |
| Table / data density | — (component) | none — compose ArxaKitListTile / custom |
| Empty state | `_empty-state.tsx` | none — compose icon + copy + ArxaKitNativeButton |
| Loading / skeleton | — (motion.css) | ArxaKitNativeLoadingIndicator, ArxaKitNativeProgress, ArxaKitLazyIndexedStack |
| Pagination / load-more | — (components) | ArxaKitLazyIndexedStack |
