...
///
/// The desktop rendering of startup. It hosts the nested-router outlet the
...
///
/// History: git log --follow -- tool/spike-q11-shells/golden/lib/ui/views/spike_startup_shell/spike_startup_shell_view.desktop.dart
library;
...
class SpikeStartupShellViewDesktop
    extends ViewModelWidget<SpikeStartupShellViewModel> {
  const SpikeStartupShellViewDesktop({super.key});
  ...
  @override
  Widget build(BuildContext context, SpikeStartupShellViewModel viewModel) {
