...
///
/// The tablet rendering of startup. It hosts the nested-router outlet the
...
///
/// History: git log --follow -- tool/spike-q11-shells/golden/lib/ui/views/spike_startup_shell/spike_startup_shell_view.tablet.dart
library;
...
class SpikeStartupShellViewTablet
    extends ViewModelWidget<SpikeStartupShellViewModel> {
  const SpikeStartupShellViewTablet({super.key});
