...
///
/// The desktop rendering of the splash surface. Brand mark only: no
...
///
/// History: git log --follow -- tool/spike-q11-shells/golden/lib/ui/views/spike_startup_shell/spike_splashscreen/spike_splashscreen_view.desktop.dart
library;
...
class SpikeSplashscreenViewDesktop
    extends ViewModelWidget<SpikeSplashscreenViewModel> {
  const SpikeSplashscreenViewDesktop({super.key});
