...
///
/// History: git log --follow -- tool/spike-q11-shells/golden/lib/ui/views/spike_application_shell/spike_home/spike_home_view.desktop.dart
library;
...
class SpikeHomeViewDesktop
    extends ViewModelWidget<SpikeHomeViewModel> {
  const SpikeHomeViewDesktop({super.key});
