...
///
/// The mobile rendering of application. It hosts the nested-router outlet
...
///
/// History: git log --follow -- tool/spike-q11-shells/golden/lib/ui/views/spike_application_shell/spike_application_shell_view.mobile.dart
library;
...
class SpikeApplicationShellViewMobile
    extends ViewModelWidget<SpikeApplicationShellViewModel> {
  const SpikeApplicationShellViewMobile({super.key});
