...
///
/// The tablet rendering of auth. It hosts the nested-router outlet the leaf
/// renders through.
///
/// Requirements:
/// 1. [Placeholder]
...
///
/// History: git log --follow -- tool/spike-q11-shells/golden/lib/ui/views/spike_auth_shell/spike_auth_shell_view.tablet.dart
library;
...
class SpikeAuthShellViewTablet
    extends ViewModelWidget<SpikeAuthShellViewModel> {
  const SpikeAuthShellViewTablet({super.key});
