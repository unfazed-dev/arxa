...
///
/// The desktop rendering of auth. It hosts the nested-router outlet the
...
///
/// History: git log --follow -- tool/spike-q11-shells/golden/lib/ui/views/spike_auth_shell/spike_auth_shell_view.desktop.dart
library;
...
class SpikeAuthShellViewDesktop
    extends ViewModelWidget<SpikeAuthShellViewModel> {
  const SpikeAuthShellViewDesktop({super.key});
