...
///
/// The mobile rendering of design. It hosts the nested-router outlet the
...
///
/// History: git log --follow -- tool/spike-q11-shells/golden/lib/ui/views/spike_design_shell/spike_design_shell_view.mobile.dart
library;
...
class SpikeDesignShellViewMobile
    extends ViewModelWidget<SpikeDesignShellViewModel> {
  const SpikeDesignShellViewMobile({super.key});
