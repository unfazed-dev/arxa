...
///
/// The tablet rendering of design. It hosts the nested-router outlet the
...
///
/// History: git log --follow -- tool/spike-q11-shells/golden/lib/ui/views/spike_design_shell/spike_design_shell_view.tablet.dart
library;
...
class SpikeDesignShellViewTablet
    extends ViewModelWidget<SpikeDesignShellViewModel> {
  const SpikeDesignShellViewTablet({super.key});
