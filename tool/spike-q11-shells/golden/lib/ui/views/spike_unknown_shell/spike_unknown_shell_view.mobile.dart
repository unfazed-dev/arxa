...
///
/// The mobile rendering of unknown. It hosts the nested-router outlet the
...
///
/// History: git log --follow -- tool/spike-q11-shells/golden/lib/ui/views/spike_unknown_shell/spike_unknown_shell_view.mobile.dart
library;
...
class SpikeUnknownShellViewMobile
    extends ViewModelWidget<SpikeUnknownShellViewModel> {
  const SpikeUnknownShellViewMobile({super.key});
