...
///
/// The tablet rendering of not found.
///
/// Requirements:
/// 1. [Placeholder]
...
///
/// History: git log --follow -- tool/spike-q11-shells/golden/lib/ui/views/spike_unknown_shell/spike_notfound/spike_notfound_view.tablet.dart
library;
...
class SpikeNotfoundViewTablet
    extends ViewModelWidget<SpikeNotfoundViewModel> {
  const SpikeNotfoundViewTablet({super.key});
