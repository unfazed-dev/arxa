...
///
/// The desktop rendering of not found.
///
/// Requirements:
/// 1. [Placeholder]
...
///
/// History: git log --follow -- tool/spike-q11-shells/golden/lib/ui/views/spike_unknown_shell/spike_notfound/spike_notfound_view.desktop.dart
library;
...
class SpikeNotfoundViewDesktop
    extends ViewModelWidget<SpikeNotfoundViewModel> {
  const SpikeNotfoundViewDesktop({super.key});
