...
import 'package:ui_library/widgets/kit_native_search_bar.dart';
...
void main() {
  ...
  testWidgets('Android wantNative routes to Material SearchBar', (tester) async {
    ...
    await tester.pumpWidget(host(const KitNativeSearchBar()));
  ...
  testWidgets('default platform builds clean', (tester) async {
    await tester.pumpWidget(host(const KitNativeSearchBar(hint: 'Find')));
  ...
  testWidgets('onChanged is wired (text entered via the controller-backed field)',
    ...
    String? fired;
    await tester.pumpWidget(host(KitNativeSearchBar(
  ...
  testWidgets('actionLabel without onAction renders no button', (tester) async {
    ...
    await tester.pumpWidget(
        host(const KitNativeSearchBar(actionLabel: 'Cancel')));
