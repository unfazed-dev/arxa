...
/// Adaptive search bar — two-way structural gate (mirrors [KitNativeTabBar]'s
...
class KitNativeSearchBar extends StatelessWidget {
  const KitNativeSearchBar({
    super.key,
    this.hint,
    this.controller,
    this.onChanged,
  ...
  Widget build(BuildContext context) {
    final isCN = wantNative &&
        KitPlatform.supportsLiquidGlass &&
        !KitPlatform.supportsComposeM3E;
