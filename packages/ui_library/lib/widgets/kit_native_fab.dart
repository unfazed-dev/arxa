...
/// [KitNativeButton] for the same convention.
///
/// [onPressed] is nullable: `null` disables the button on every tier.
class KitNativeFab extends StatelessWidget {
  const KitNativeFab({
    super.key,
    this.icon,
    this.sfSymbol,
  ...
  Widget _m3e(BuildContext context) {
    ...
    // KitFabMorph (not FabM3E): a filled/elevated M3E FAB that shape-morphs on
