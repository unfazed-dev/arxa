...
/// A horizontal rail of chips (usually `KitChip`s) — edge-faded when the
...
/// chip-rail surface to wrap, so this widget is named `KitChipCarousel` (a
/// content widget), **not** `KitNativeChipCarousel`. See
...
///   default.
class KitChipCarousel extends StatefulWidget {
  const KitChipCarousel({
    super.key,
    required this.children,
    this.spacing = kPad8,
    this.padding = const EdgeInsets.symmetric(horizontal: kPad16),
    this.snap = false,
    this.fadeExtent = kSize24,
  });
  ...
  /// Gap between chips. Defaults to [kPad8].
  ...
  @override
  State<KitChipCarousel> createState() => _KitChipCarouselState();
}

class _KitChipCarouselState extends State<KitChipCarousel> {
  ...
  @override
  void didUpdateWidget(KitChipCarousel oldWidget) {
