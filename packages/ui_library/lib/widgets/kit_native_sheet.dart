...
///   floating [KitFrostedSurface] panel (28 dp corners, blur 30) with a
...
///
/// Mirrors [KitNotificationService]'s tier-routing pattern
/// (reuses existing infra rather than reinventing a sheet controller).
Future<T?> kitShowNativeSheet<T>({
  ...
  // ([KitNativeChromeGate], [KitScrollOcclusionGate], `CNSearchBar`'s
...
/// [KitFrostedSurface] panel — horizontal inset + safe-area-aware bottom
...
class _SheetGrabber extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Center(
        child: Container(
          key: const ValueKey<String>('kitNativeSheetGrabber'),
          width: 36,
          height: 5,
