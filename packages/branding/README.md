...
Reusable brand layer for `stacked_kit`-built apps. Depends **only on Flutter** —
...
views need no `stacked_kit` import for color values, and the brand accent comes
...
stacked_kit/branding/tools/generate_branding.sh /path/to/host_app
