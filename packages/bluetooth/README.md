...
`package:stacked_kit_bluetooth/testing.dart` exports `FakeKitBluetoothService`:
...
No path dependency on `stacked_kit_permissions` (or any kit). The Android 12+
