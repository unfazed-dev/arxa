...
import 'package:appbox_kit_data/storage/appwrite/kit_appwrite_storage_service.dart';

/// Live-credentials contract test for [KitAppwriteStorageService].
///
/// Env-var skip convention (see kit_supabase_storage_service_test.dart):
...
void main() {
  ...
  group(
    'KitAppwriteStorageService contract',
    () {
      ...
      test('upload → getUrl → delete round trip', () async {
        final service =
            KitAppwriteStorageService(storage: storage, client: client);
