...
import 'package:appbox_kit_data/storage/supabase/kit_supabase_storage_service.dart';

/// Live-credentials contract test for [KitSupabaseStorageService].
///
...
void main() {
  ...
  group(
    'KitSupabaseStorageService contract',
    () {
      ...
      test('upload → getUrl → delete round trip', () async {
        final service = KitSupabaseStorageService(client: client);
