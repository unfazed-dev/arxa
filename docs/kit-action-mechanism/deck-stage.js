 ...
 *     Static slide markup keeps every later tweak a simple text edit — you or
 *     the user can change a heading directly in the file; a slide rendered
 *     through <script type="text/babel">, React, or a loop over a JS array
 *     forces every tweak to reason through the render layer. Reach for
 *     script-generated slides only when the content genuinely needs
 *     interactive behaviour static HTML can't express.
...
(() => {
  ...
  class DeckStage extends HTMLElement {
    ...
    _render() {
      ...
      // A panning canvas (design-canvas) hooks wheel to pan the canvas; this
      // opts the rail's own scrollview out so thumbnails stay scrollable.
