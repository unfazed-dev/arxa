...
**Goal.** arxa designs and builds **itself** — proving the designer on a
...
|---|---|---|---|
| **D1** | arxa's own macOS desktop app | `macos` | desktop only → **3 layout files** |
...
- [ ] **14.1** Run `arxa-designer` against
      [`../../design/arxa-persona-design-brief.md`](../../design/arxa-persona-design-brief.md) to produce **D1**: 14
...
- [ ] **14.19** **Michelle's path:** on a clean machine with no arxa context,
...
4. arxa's macOS app, built by arxa, runs and can drive its own pipeline.
