...
Findings that led to arxa's architecture. Every claim here was measured by
...
| doc | what it's for |
|---|---|
| [flutter-genui.md](flutter-genui.md) | Docs digest (2026-07-28) for the GenUI design direction: package status, A2UI architecture, the arxa-as-A2UI-server fit, custom-catalog consequences. |
