...
This is the finding that matters for app_box. It is not a bug in either system —
...
Neither is right. app_box wants the frozen-HTML-per-branch input (stacked_kit's
