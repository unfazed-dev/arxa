...
5. **Two output pipelines exist**: `appbox emit scaffold` (Flutter, the one that matters here) and `appbox design eject` (`design_tools.dart:1208`, non-Flutter htmx hardening).
