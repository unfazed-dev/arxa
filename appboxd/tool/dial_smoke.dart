...
Future<void> main(List<String> args) async {
  ...
  // appbox-cdp instances from earlier crashed runs starved the machine hard
...
Future<void> _cleanup() async {
  ...
  for (final line in credsFile.readAsStringSync().split('\n')) {
    ...
    if (k == 'APPBOX_SUPABASE_URL' || k == 'url') url = v;
    if (k == 'APPBOX_SUPABASE_SERVICE_KEY' || k == 'service_key') key = v;
  }
