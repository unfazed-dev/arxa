...
//
// Run:  cd appboxd && dart run tool/warm_anim_probe.dart   (~12 min)
//
...
String buildSection({
  ...
  final b = StringBuffer()
    ...
    ..writeln('### Setup')
    ..writeln()
    ..writeln('- Probe: `appboxd/tool/warm_anim_probe.dart`')
    ..writeln('- Reproduce: `cd appboxd && dart run tool/warm_anim_probe.dart`')
    ..writeln('- Source: `$prov`')
