...
void main() {
  group('lens glow', () {
    ...
    test('injectLensGlow adds the overlay; removeLensGlow clears it', () async {
      ...
      expect(await tab.evaluate('!!document.getElementById("appbox-lens-glow")'),
          true);
      expect(
          await tab.evaluate('!!document.getElementById("appbox-lens-glow-label")'),
          true);
    ...
    test('glow is parented to documentElement, not body', () async {
      ...
      expect(
          await tab.evaluate(
              'document.getElementById("appbox-lens-glow") && '
              '!document.body.contains(document.getElementById("appbox-lens-glow"))'),
          true);
    });
