...
//   - kit dep prefix is `appbox_kit` (renamed from stacked_kit)
...
/// The kit-package name prefix (renamed from stacked_kit_* → appbox_kit_*).
const String kitPrefix = 'appbox_kit';
