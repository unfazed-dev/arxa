...
//
// MEM-A is the repo's own memory/ (how appbox behaves). MEM-B is the memory
...
// Readable by someone who has never installed appbox; neither file reads the
...
String assembleMemB(
  ...
  final out = StringBuffer()
    ...
    ..writeln()
    ..writeln('> appbox MEM-B (architecture §4): what happened to THIS app. '
        'Travels with the delivered codebase and is readable without appbox '
