...
//
// Dart port of skills/appbox-deployer/deploy.py (plan 11 / Architecture §17).
// The deploy kit (`appbox_kit_deploy`) is pure-Dart, standalone, registry
...
export 'package:appboxd/process.dart' show ProcessRunner, RunnerResult;
...
class Deployer {
  ...
  /// --ledger / $APPBOX_DEPLOY_LEDGER resolution.
