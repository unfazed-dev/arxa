...
//
// Port of appbox_kit/tools/capability_scan.sh. Scans a CONSUMER app (the
// Flutter app in appbox/, or a generated target) for audio/video PLAYBACK
...
//           (a bare appbox_kit_media dep is NOT flagged: the kit mixes capture
...
final _signals = <(String, RegExp, String)>[
  ...
  (
    ...
    'appbox_kit_media AudioPlayerService',
  ),
  (
    _video,
