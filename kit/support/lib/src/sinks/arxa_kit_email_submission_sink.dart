...
///
/// TODO(arxa_kit_support): route the submission to an inbox. Implement one:
...
/// Map ArxaKitFeedbackSubmission.text -> body, .screenshot -> attachment,
...
/// a host opts in.
class ArxaKitEmailSubmissionSink implements ArxaKitSubmissionSink {
  ArxaKitEmailSubmissionSink({this.id = 'email', this.recipient});
  ...
  Future<ArxaKitSubmissionResult> submit(ArxaKitFeedbackSubmission submission) async =>
      throw UnimplementedError('ArxaKitEmailSubmissionSink.submit is a stub');
}
