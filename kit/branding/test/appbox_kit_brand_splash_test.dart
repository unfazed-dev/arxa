import 'package:appbox_kit_branding/appbox_kit_testing.dart';
import 'package:flutter/material.dart';
import 'package:flutter_test/flutter_test.dart';

/// Behavior suite for [AppBoxKitBrandSplash] — the only runtime surface of the
  ...
  group('AppBoxKitBrandSplash', () {
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.pumpWidget(appBoxKitBrandSplashTestApp(
          brand: fakeAppBoxKitBrandMark(key: brandKey),
        ));
        // when
        final size = tester.getSize(find.byKey(brandKey));
        final center = tester.getCenter(find.byKey(brandKey));
        // then
        expect(size, const Size(AppBoxKitBrandSplash.logoSize,
            AppBoxKitBrandSplash.logoSize));
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.pumpWidget(
            appBoxKitBrandSplashTestApp(caption: 'move everyday'));
        // when
    ...
    testWidgets(
      ...
      (tester) async {
        // given
        await tester
            .pumpWidget(appBoxKitBrandSplashTestApp(duration: const Duration(seconds: 1)));
