import '../../arxa_kit_locator.dart' show arxaKitLocator;
import '../error/arxa_kit_error_service.dart';
...
class ArxaKitThemeService with ListenableServiceMixin, WidgetsBindingObserver {
  ...
  // kit's generic palette — see arxa_kit_colors.dart (arxaKitLightTheme / arxaKitDarkTheme);
