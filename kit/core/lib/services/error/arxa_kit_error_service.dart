...
enum ArxaKitErrorSeverity { low, medium, high, critical, info, warning }

/// ErrorService - A reactive service for error handling and logging
/// following Stacked architecture patterns.
class ArxaKitErrorService with ListenableServiceMixin {
    ...
    try {
      final relevantLine = stackTrace.toString().split('\n').firstWhere(
            (line) =>
                ...
                !line.contains('ArxaKitErrorService._logWithTalker') &&
                !line.contains('ArxaKitErrorService.debug') &&
                !line.contains('ArxaKitErrorService.info') &&
                !line.contains('ArxaKitErrorService.warning') &&
                !line.contains('ArxaKitErrorService.error') &&
                !line.contains('ArxaKitErrorService.critical') &&
                !line.contains('ArxaKitErrorService.verbose') &&
                !line.contains('ArxaKitErrorService.handle') &&
                !line.contains('ArxaKitErrorService.logEvent') &&
                line.contains(':'),
            orElse: () => stackTrace
                .toString()
                .split('\n')
