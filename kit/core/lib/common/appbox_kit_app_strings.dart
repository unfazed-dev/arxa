...
// - Every user-facing fixed string (copy) in an appbox app is declared here
//   as an `abxStr`-prefixed const — `abx` matches
//   appbox_kit_app_constants.dart style, `Str` marks it as string copy.
// - The design refers to the NAME, never to loose words. design.json stores
//   the name; the scaffolder emits the same name as a Dart const; appbox
...
// - Each app owns its own appbox_kit_app_strings.dart (scaffolded into
//   lib/ui/common/ alongside the kit common copy). This kit file carries
//   only strings generic to every appbox app.
