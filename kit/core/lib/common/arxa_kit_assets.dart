...
// - Every bundled asset path in an arxa app is declared here as an
...
//   An app declares NO font assets of its own. Ruling exception: arxa studio's own
...
// - Each app owns its own arxa_kit_assets.dart (scaffolded into
//   lib/ui/common/ alongside the kit common copy). This kit file carries
//   only assets generic to every arxa app; app-specific assets belong in
//   the app copy.
