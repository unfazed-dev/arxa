...
/// `skills/arxa-designer/references/app-architecture.md:169`. The JS object
/// spells the third key `nodeId`; Dart spells it [anatomyNodeId], per
/// `skills/arxa-scaffolder/SKILL.md:263`. Same slot, two spellings — the
...
/// `skills/arxa-scaffolder/kind-resolution.registry.json`
...
class ArxaKitInspectAttrs {
  ...
  @override
  String toString() => 'ArxaKitInspectAttrs(screenId: $screenId, '
