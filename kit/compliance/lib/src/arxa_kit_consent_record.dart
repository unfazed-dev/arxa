...
/// [ArxaKitConsentMethod.withdrawn], not a deletion.
@immutable
final class ArxaKitConsentRecord {
  const ArxaKitConsentRecord({
  ...
  final ArxaKitConsentMethod method;
  ...
  bool get isWithdrawal => method == ArxaKitConsentMethod.withdrawn;

  @override
  bool operator ==(Object other) =>
      other is ArxaKitConsentRecord &&
  ...
  @override
  String toString() =>
      'ArxaKitConsentRecord(documentId: $documentId, version: $documentVersion, '
