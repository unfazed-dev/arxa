...
/// of text.
@immutable
final class ArxaKitLicenseEntry {
  const ArxaKitLicenseEntry({required this.packages, required this.paragraphs});
  ...
  @override
  String toString() =>
      'ArxaKitLicenseEntry(packages: $packages, ${paragraphs.length} paragraphs)';
}
