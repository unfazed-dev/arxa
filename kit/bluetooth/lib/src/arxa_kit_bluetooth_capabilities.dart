...
class ArxaKitBluetoothCapabilities {
  const ArxaKitBluetoothCapabilities({
  ...
  static const androidDialog = ArxaKitBluetoothCapabilities(canControlAdapter: true);

  /// iOS / other: observe + escort only.
  static const escortOnly = ArxaKitBluetoothCapabilities(canControlAdapter: false);
}
