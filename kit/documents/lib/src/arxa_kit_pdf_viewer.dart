...
/// rasterization use [ArxaKitPdfrxPdfService] instead.
class ArxaKitPdfViewer extends StatelessWidget {
  const ArxaKitPdfViewer.data(
    Uint8List bytes, {
    super.key,
  ...
  const ArxaKitPdfViewer.network(
    String url, {
    super.key,
    this.params = const PdfViewerParams(),
    this.controller,
  ...
  /// [ArxaKitPdfViewer.data] (bytes carry no identity); the path/URL constructors
