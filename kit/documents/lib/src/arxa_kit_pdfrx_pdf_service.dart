...
import 'arxa_kit_pdf_service.dart';

/// [ArxaKitPdfService] backed by `pdfrx` (PDFium).
///
...
/// assemble them.
class ArxaKitPdfrxPdfService implements ArxaKitPdfService {
  ...
  // TODO(arxa_kit_documents): pdfrx renders only — assemble via
