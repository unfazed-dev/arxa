...
/// [ArxaKitChatStream] over the Anthropic messages API.
///
  ...
  Stream<String> complete(List<ArxaKitChatMessage> messages,
    ...
    final system = [
      for (final m in messages)
        if (m.role == ArxaKitChatRole.system) m.content,
    ].join('\n\n');
    final body = <String, Object?>{
      ...
      'messages': [
        for (final m in messages)
          if (m.role != ArxaKitChatRole.system)
