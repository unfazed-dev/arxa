...
/// Interface-level contract for [ArxaKitStorageService]. Any backend should
...
void main() {
  ...
  test('kit.data.storage — ArxaKitStorageObjectRef id defaults to path and equals by value', () {
    final a = const ArxaKitStorageObjectRef(bucket: 'b', path: 'p');
    final b = const ArxaKitStorageObjectRef(bucket: 'b', path: 'p');
    final explicit = const ArxaKitStorageObjectRef(bucket: 'b', path: 'p', id: 'x');
