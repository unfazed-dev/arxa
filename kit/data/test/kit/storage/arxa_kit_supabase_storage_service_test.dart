...
import 'package:arxa_kit_data/storage/supabase/arxa_kit_supabase_storage_service.dart';

/// Live-credentials contract test for [ArxaKitSupabaseStorageService].
///
...
void main() {
  ...
  group(
    'ArxaKitSupabaseStorageService contract',
    () {
      ...
      test('kit.data.storage — upload → getUrl → delete round trip', () async {
        final service = ArxaKitSupabaseStorageService(client: client);
