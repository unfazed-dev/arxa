...
void main() {
  ...
  ArxaKitFixtureLoader loaderFor(Map<String, String> assets) =>
      ArxaKitFixtureLoader(
          idService: idService, assetReader: ArxaKitMemoryAssetReader(assets));
