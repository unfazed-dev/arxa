...
/// `ArxaKitDataConfig.backend` that picks the repositories. Auth deliberately
/// does NOT reuse `ArxaKitRepository<T>`: session state has its own lifecycle.
///
...
abstract interface class ArxaKitAuthService {
  ...
  /// `null` = signed out.
  Stream<ArxaKitAuthSession?> get session$;

  ArxaKitAuthSession? get currentSession;
