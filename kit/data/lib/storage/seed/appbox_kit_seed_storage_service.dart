...
import 'appbox_kit_storage_persistence.dart';

/// In-memory [AppBoxKitStorageService] with optional write-through durability,
/// mirroring how [AppBoxKitSeedRepository] layers over [AppBoxKitSeedStore].
///
...
class AppBoxKitSeedStorageService implements AppBoxKitStorageService {
  final AppBoxKitStoragePersistence persistence;

  AppBoxKitSeedStorageService({this.persistence = const AppBoxKitNoStoragePersistence()});
  ...
  Future<String> getUrl(AppBoxKitStorageObjectRef ref) async {
    ...
    if (stored == null) {
      throw StateError(
        'AppBoxKitSeedStorageService: no object at ${ref.bucket}/${ref.path}',
      );
    }
