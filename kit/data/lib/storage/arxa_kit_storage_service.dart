...
/// delete, or share an object previously written through [ArxaKitStorageService].
///
...
class ArxaKitStorageObjectRef {
  ...
  bool operator ==(Object other) =>
      ...
      other is ArxaKitStorageObjectRef &&
          other.bucket == bucket &&
          other.path == path &&
          other.id == id;
  ...
  @override
  String toString() => 'ArxaKitStorageObjectRef(bucket: $bucket, path: $path, id: $id)';
}

/// Blob-storage seam mirroring [ArxaKitRepository] — one swap surface, three
/// backends (seed / supabase / appwrite), selected by the same
/// [ArxaKitDataBackend] as the repositories.
///
...
///   has no HTTP origin.
abstract interface class ArxaKitStorageService {
  /// Stores [bytes] at `bucket/path`. Returns the canonical [ArxaKitStorageObjectRef]
  ...
  Future<void> delete(ArxaKitStorageObjectRef ref);
}
