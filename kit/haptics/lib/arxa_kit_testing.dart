/// Test doubles for arxa_kit_haptics.
///
/// ```dart
...
import 'src/arxa_kit_haptic_service.dart';

/// A scriptable, platform-free stand-in for [ArxaKitHapticService].
///
/// Substitute it in the locator (`registerSingleton<ArxaKitHapticService>(...)`)
...
/// invocations instead.
class FakeArxaKitHapticService extends ArxaKitHapticService {
  FakeArxaKitHapticService({
    ...
    Object? triggerError,
        ...
        triggerError = triggerError ?? Exception('FakeArxaKitHapticService failure');
