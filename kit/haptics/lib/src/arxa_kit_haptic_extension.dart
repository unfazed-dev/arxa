import 'arxa_kit_haptic_locator.dart';
import 'arxa_kit_haptic_service.dart';
...
class _HapticGestureDetector extends StatelessWidget {
  ...
  Future<void> _handleTap() async {
    try {
      await arxaKitLocator<ArxaKitHapticService>().triggerHaptic(type);
    } catch (e) {
...
extension ArxaKitHapticExtension on Widget {
