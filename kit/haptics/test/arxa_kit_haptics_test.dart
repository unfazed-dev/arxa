...
import 'package:arxa_kit_haptics/src/arxa_kit_haptic_locator.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:flutter_test/flutter_test.dart';
import 'package:shared_preferences/shared_preferences.dart';

/// Behavior tests for arxa_kit_haptics.
///
/// Seams:
...
/// - `FakeArxaKitHapticService` (from `arxa_kit_testing.dart`) stands in
...
void main() {
  ...
  group('ArxaKitHapticService', () {
    test(
      ...
      () async {
        ...
        final service = ArxaKitHapticService();
  ...
  group('ArxaKitHapticExtension', () {
    testWidgets(
      'kit.haptics.locator — withSuccessHaptic resolves the registered service through the locator',
      (tester) async {
        // given
        final fake = FakeArxaKitHapticService();
        arxaKitLocator.registerSingleton<ArxaKitHapticService>(fake);
        var tapped = false;
