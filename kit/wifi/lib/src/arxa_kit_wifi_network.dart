...
/// on a [ArxaKitWifiState.connected] device usually means "permission not
/// granted", not "no network". Consumers should treat the whole object as a
/// hint, never as authoritative connection state.
class ArxaKitWifiNetwork {
  const ArxaKitWifiNetwork({
    this.ssid,
    this.bssid,
    this.ipAddress,
  });
  ...
  @override
  String toString() =>
      'ArxaKitWifiNetwork(ssid: $ssid, bssid: $bssid, ipAddress: $ipAddress)';
}
