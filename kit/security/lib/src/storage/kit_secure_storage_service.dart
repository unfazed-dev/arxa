...
/// (`FlutterSecureStorageKitSecureStorageService`) wraps `flutter_secure_storage`
/// (iOS Keychain / Android Keystore-backed EncryptedSharedPreferences); the
/// scriptable fake lives in `package:appbox_kit_security/testing.dart`.
///
/// This is where secrets at rest live — an app-held crypto key, a hashed PIN,
/// a session token. Values are opaque to the port; use [KitCryptoService] to
/// encrypt structured payloads before writing them here if you need more than
/// the platform's own at-rest encryption.
abstract interface class KitSecureStorageService {
