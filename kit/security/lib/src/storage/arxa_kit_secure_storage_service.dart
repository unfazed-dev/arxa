...
/// (`FlutterSecureStorageArxaKitSecureStorageService`) wraps `flutter_secure_storage`
/// (iOS Keychain / Android Keystore-backed EncryptedSharedPreferences); the
/// scriptable fake lives in `package:arxa_kit_security/arxa_kit_testing.dart`.
///
/// This is where secrets at rest live — an app-held crypto key, a hashed PIN,
/// a session token. Values are opaque to the port; use [ArxaKitCryptoService] to
/// encrypt structured payloads before writing them here if you need more than
/// the platform's own at-rest encryption.
abstract interface class ArxaKitSecureStorageService {
