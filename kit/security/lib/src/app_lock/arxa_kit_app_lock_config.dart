...
/// Tuning for [ArxaKitAppLockController].
@immutable
class ArxaKitAppLockConfig {
  const ArxaKitAppLockConfig({
  ...
  ArxaKitAppLockConfig copyWith({
    Duration? lockOnBackgroundAfter,
    int? maxAttempts,
    Duration? cooldown,
    String? unlockReason,
  }) =>
      ArxaKitAppLockConfig(
  ...
  @override
  String toString() =>
      'ArxaKitAppLockConfig(lockOnBackgroundAfter: $lockOnBackgroundAfter, '
