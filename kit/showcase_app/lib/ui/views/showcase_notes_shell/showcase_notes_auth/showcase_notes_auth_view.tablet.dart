...
///                                7. anonymous
///
/// History: git log --follow -- kit/showcase_app/lib/ui/views/showcase_notes_shell/showcase_notes_auth/showcase_notes_auth_view.tablet.dart
library;
...
class ShowcaseNotesAuthViewTablet
    extends ViewModelWidget<ShowcaseNotesAuthViewModel> {
  const ShowcaseNotesAuthViewTablet({super.key});
  ...
  Widget build(BuildContext context, ShowcaseNotesAuthViewModel viewModel) {
    return const Scaffold(
      body: Center(
        child: Text(
          'Hello, TABLET UI - ShowcaseNotesAuthView!',
          style: TextStyle(
            fontSize: 35,
