/// The home shell's viewmodel (route `/showcase/home-shell`). The shell view
/// calls actions in and reads streams out — once real behavior lands; right
/// now the shell is a passive nested-router outlet, so there is nothing to
/// call or read yet. The viewmodel never touches the view — swap the UI for
/// any other and this file stays unchanged.
///
/// This is the business logic for the home shell's outer frame. It holds the
/// slot the shell view binds to while a nested router fills the body with the
/// home tab.
///
/// Requirements:
/// 1. [Shell host]
