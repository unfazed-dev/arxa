...
abstract final class ArxaKitGlyphs {
  ...
  static const alertsBadge =
      ArxaKitGlyph(Icons.notifications_active, 'bell.badge');
  ...
  static const notes =
      ArxaKitGlyph(Icons.sticky_note_2_outlined, 'note.text');
  ...
  static const chevronRight =
      ArxaKitGlyph(Icons.chevron_right, 'chevron.right');
  ...
  static const support =
      ArxaKitGlyph(Icons.support_agent, 'questionmark.circle.fill');
  ...
  static const shield =
      ArxaKitGlyph(Icons.verified_user, 'checkmark.shield.fill');
  ...
  /// with `truck.box.fill`.
  static const truck =
      ArxaKitGlyph(Icons.local_shipping_outlined, 'truck.box.fill');

  /// Sealed package / parcel (an order + tracking number).
  static const package =
      ArxaKitGlyph(Icons.inventory_2_outlined, 'shippingbox.fill');
  ...
  static const back =
      ArxaKitGlyph(Icons.arrow_back_ios_new, 'chevron.backward');
