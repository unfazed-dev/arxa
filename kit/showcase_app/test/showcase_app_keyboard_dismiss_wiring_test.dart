...
// (AppBoxKitInputTapBehavior — proven in the kit,
// appbox_kit_input_keyboard_behavior_test.dart). What only a showcase test can
...
import 'package:appbox_kit_ui_library/appbox_kit_ui_library.dart'
    show AppBoxKitInputTapBehavior;
...
void main() {
  ...
  testWidgets(
    ...
    // composes AppBoxKitNativeTextField — assert the per-input default rides
    ...
    expect(
      find.descendant(
        ...
        matching: find.byType(AppBoxKitInputTapBehavior),
      ),
      findsOneWidget,
