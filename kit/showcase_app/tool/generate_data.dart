...
final List<ArxaKitTableSchema> showcaseSchemas = [
...
Future<Map<String, String>> _emitAll(Directory seedDir, String databaseId) async {
  ...
  return {
    'supabase_migration.sql': ArxaKitSupabaseSqlEmitter().emit(showcaseSchemas),
    'supabase_seed.sql': ArxaKitSupabaseSeedEmitter(idService: ArxaKitIdService())
        .emit(fixturesByTable: fixturesByTable, schemasByTable: schemasByTable),
    'appwrite.tables.json': ArxaKitAppwriteJsonEmitter()
