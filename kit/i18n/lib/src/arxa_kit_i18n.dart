...
import 'arxa_kit_language.dart';
import 'arxa_kit_locale_store.dart';
...
class ArxaKitI18n extends ChangeNotifier {
  ArxaKitI18n({required ArxaKitLocaleStore store, Locale? systemLocale})
    : _store = store,
      _systemLocale = systemLocale;

  final ArxaKitLocaleStore _store;
  ...
  String get bcp47 =>
      _override ?? _systemLocale?.toLanguageTag() ?? ArxaKitLanguage.fallback.tag;
  ...
  ArxaKitLanguage get language =>
      ArxaKitLanguage.byTag(bcp47) ?? ArxaKitLanguage.fallback;
