...
/// or native compose/send seams — see [ArxaKitSmsBackend] and [ArxaKitEmailBackend].
abstract class ArxaKitOutboundMessageSink {
  /// Channel identifier, e.g. `sms` or `email`.
  String get channel;

  /// Send [message]. Throws on delivery failure so callers can react.
  Future<void> send(ArxaKitOutboundMessage message);
}
