...
import 'arxa_kit_springs.dart';

/// A gesture-driven 0→1 driver for `ArxaKitMotionScope`: drag input scrubs the
...
class ArxaKitGestureDriver extends AnimationController {
  ArxaKitGestureDriver({
    required super.vsync,
    double initialValue = 0.0,
    this.settleSpring = ArxaKitSprings.snappy,
    this.completionThreshold = 0.5,
    super.debugLabel,
  }) : super(value: initialValue);

  /// The spring [settle] lands with; presets live in [ArxaKitSprings]. Mutable
