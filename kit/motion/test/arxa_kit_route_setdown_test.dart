...
/// ArxaKitMotionScope must scrub ArxaKitWake children back down while its route pops.
    ...
    testWidgets('kit.motion.route-setdown — route pop scrubs the wake back down (${kind.name})',
      ...
      double wakeOpacity() => tester
          .widget<FadeTransition>(find.descendant(
              of: find.byType(ArxaKitWake), matching: find.byType(FadeTransition)))
          .opacity
          .value;
