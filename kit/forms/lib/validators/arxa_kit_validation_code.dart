...
///
/// These are the *primary* keys hosts localize against — every [ArxaKitValidators]
/// factory tags its [ArxaKitFieldError] with one. The English fallback strings live
/// in `ArxaKitErrorMessages`; hosts may ignore those and resolve off the code.
abstract final class ArxaKitValidationCode {
