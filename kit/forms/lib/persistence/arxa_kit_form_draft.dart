...
abstract interface class ArxaKitFormDraftStore {
...
/// STUB placeholder: an in-memory [ArxaKitFormDraftStore] (lost on restart).
///
/// Useful for tests and wiring the seam; swap for durable storage in the draft
/// phase.
class ArxaKitInMemoryDraftStore implements ArxaKitFormDraftStore {
