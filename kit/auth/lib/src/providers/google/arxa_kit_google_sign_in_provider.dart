...
/// [ArxaKitAuthFailureReason.cancelled]; configuration problems map to
/// [ArxaKitAuthFailureReason.operationNotAllowed].
class ArxaKitGoogleSignInProvider implements ArxaKitOAuthProvider {
  ...
  Future<ArxaKitAuthResult> signIn() async {
    try {
      ...
      return switch (e.code) {
        GoogleSignInExceptionCode.canceled => ArxaKitAuthFailure(
