...
void main() {
  ...
  testWidgets(
    ...
    await tester.pumpWidget(harness(
      controller: controller,
      style: ArxaKitScrollEdgeEffectStyle.soft,
    ));
  ...
  testWidgets(
    ...
    await tester.pumpWidget(harness(
      controller: controller,
      style: ArxaKitScrollEdgeEffectStyle.hard,
    ));
  ...
  testWidgets(
    ...
    expect(wrapped, isA<ArxaKitScrollEdgeEffect>());
    final effect = wrapped as ArxaKitScrollEdgeEffect;
    expect(effect.style, ArxaKitScrollEdgeEffectStyle.hard);
    ...
    expect(
      find.ancestor(
        ...
        matching: find.byType(ArxaKitScrollEdgeEffect),
      ),
      findsOneWidget,
    );
  });
