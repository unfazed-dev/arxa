...
import 'package:ui_library/widgets/kit_native_loading_indicator.dart';
...
void main() {
  ...
  testWidgets('Android routes to LoadingIndicatorM3E', (tester) async {
    ...
    await tester.pumpWidget(
      host(const KitNativeLoadingIndicator(size: 32, color: Colors.blue)),
    );
  ...
  testWidgets('default platform builds clean (Material fallback)', (tester) async {
    await tester.pumpWidget(
      host(const KitNativeLoadingIndicator(size: 24, color: Colors.red)),
    );
