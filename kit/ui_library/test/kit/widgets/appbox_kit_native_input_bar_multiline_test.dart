...
/// [AppBoxKitNativeInputBar] + [AppBoxKitNativeTextField] multiline contracts —
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body: Align(
          ...
          child:
              AppBoxKitNativeInputBar(hintText: 'Message', wantNative: false),
        ),
      ),
    ));
  ...
  testWidgets(
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body: Align(
          alignment: Alignment.bottomCenter,
          child: AppBoxKitNativeInputBar(hintText: 'Message'),
        ),
      ),
    ));
