...
void main() {
  test(
    ...
    // arxa_kit_scroll_edge_effect_tier_test).
    const safeHomes = {
      'arxa_kit_frosted_surface.dart',
      'arxa_kit_scroll_edge_effect.dart',
    };
    ...
    expect(
      ...
      reason: 'saveLayer effects over subtrees that may host platform views '
          ...
          'flutter#175048). Route the effect through ArxaKitFrostedSurface '
  ...
  test(
    ...
    final src = File('lib/widgets/arxa_kit_native_floating_bar.dart')
        .readAsStringSync();
    expect(
