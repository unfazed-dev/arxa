...
void main() {
  ...
  testWidgets('fully covered child — soft keeps a faint remnant',
    ...
    await tester.pumpWidget(harness(
      controller: controller,
      style: KitScrollEdgeEffectStyle.soft,
    ));
  ...
  testWidgets('hard style fully obscures and ignores pointers', (tester) async {
    ...
    await tester.pumpWidget(harness(
      controller: controller,
      style: KitScrollEdgeEffectStyle.hard,
    ));
  ...
  testWidgets('.scrollEdgeEffect() extension wraps child in an effect',
    ...
    expect(wrapped, isA<KitScrollEdgeEffect>());
    final effect = wrapped as KitScrollEdgeEffect;
    expect(effect.style, KitScrollEdgeEffectStyle.hard);
    expect(effect.edge, KitScrollEdge.bottom);
    ...
    expect(
      find.ancestor(
        ...
        matching: find.byType(KitScrollEdgeEffect),
      ),
      findsOneWidget,
    );
  });
