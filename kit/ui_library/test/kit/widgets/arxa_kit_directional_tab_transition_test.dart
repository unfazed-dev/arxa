...
import 'package:arxa_kit_ui_library/widgets/arxa_kit_directional_tab_transition.dart';

// The child handed to ArxaKitDirectionalTabTransition is an IndexedStack that
...
void main() {
  ...
  testWidgets(
    ...
    Widget frame(int index) => Directionality(
          ...
          child: ArxaKitDirectionalTabTransition(
            activeIndex: index,
