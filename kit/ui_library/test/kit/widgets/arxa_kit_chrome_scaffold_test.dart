...
/// [ArxaKitChromeScaffold] is the liquid-glass law's reuse unit: hosts get
...
void main() {
  Widget harness({
    ...
    bool resizeToAvoidBottomInset = true,
      ...
      MaterialApp(
        home: ArxaKitChromeScaffold(
          debugForceGlassTier: forceGlass,
          behavior: behavior ?? ArxaKitFloatingBarBehavior.minimize,
          leading: leading,
          drawer: drawer,
  ...
  testWidgets(
    ...
    expect(find.byType(ArxaKitNativeAppBar), findsOneWidget);
    expect(find.byType(ArxaKitFloatingChrome), findsNothing,
  ...
  testWidgets(
    ...
    await tester.pumpWidget(
        harness(forceGlass: true, behavior: ArxaKitFloatingBarBehavior.hide));
    ...
    final chrome = tester
        .widget<ArxaKitFloatingChrome>(find.byType(ArxaKitFloatingChrome));
    expect(chrome.behavior, ArxaKitFloatingBarBehavior.hide);
    expect(chrome.title, 'Arxa Showcase');
    expect(find.byType(ArxaKitNativeAppBar), findsNothing);
    expect(
      find.descendant(
  ...
  testWidgets(
    ...
    final bar = tester
        .widget<ArxaKitNativeAppBar>(find.byType(ArxaKitNativeAppBar));
