...
// "Route transitions"): EVERY ArxaKitNative* widget that mounts a native iOS
...
// glass tier in ArxaKitNativeChromeGate — via the `.chromeGated()` sugar or the
  ...
  test(
    ...
    for (final entity in dir.listSync(recursive: true)) {
      ...
      final gated = code.contains('.chromeGated(') ||
          code.contains('ArxaKitNativeChromeGate(');
