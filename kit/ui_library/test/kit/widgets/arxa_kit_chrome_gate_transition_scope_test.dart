...
bool _gateHiddenDeep(WidgetTester tester) {
  final IndexedStack stack = tester.widget<IndexedStack>(
    find
        .descendant(
          of: find.byType(ArxaKitNativeChromeGate, skipOffstage: false),
...
void main() {
        ...
        home: Scaffold(
          body: Column(
            children: <Widget>[
              ...
              const ArxaKitNativeChromeGate(child: Text('root-tab-bar')),
            ],
          ),
        ),
      ),
  ...
  testWidgets(
    ...
    await tester.pumpWidget(
      MaterialApp(
        ...
        navigatorObservers: <NavigatorObserver>[CNTransitionObserver()],
        home: const Scaffold(
          body: ArxaKitNativeChromeGate(child: Text('root-tab-bar')),
        ),
      ),
    );
    await _settleBoot(tester);
    ...
    final Element gateElement =
        tester.element(find.byType(ArxaKitNativeChromeGate));
    ...
    expect(
      identical(
          tester.element(find.byType(ArxaKitNativeChromeGate)), gateElement),
      isTrue,
  ...
  testWidgets(
    ...
    await tester.pumpWidget(
      CupertinoApp(
        ...
        home: const CupertinoPageScaffold(
          child: ArxaKitNativeChromeGate(child: Text('in-route-glass')),
        ),
      ),
    );
    await _settleBoot(tester);
    ...
    final Element gateElement = tester.element(
      find.byType(ArxaKitNativeChromeGate, skipOffstage: false),
    );
              ...
              Expanded(
                child: Navigator(
                  ...
                  onGenerateRoute: (RouteSettings settings) =>
                      CupertinoPageRoute<void>(
                    settings: settings,
                    builder: (_) => const ArxaKitNativeChromeGate(
              ...
              child: ElevatedButton(
                onPressed: () => showModalBottomSheet<void>(
                  ...
                  builder: (_) => const SizedBox(
                    height: 300,
                    child:
                        ArxaKitNativeChromeGate(child: Text('sheet-glass')),
                  ),
                ),
...
List<bool> _allGatesHidden(WidgetTester tester) {
  return find
      .byType(ArxaKitNativeChromeGate, skipOffstage: false)
      .evaluate()
      .map((Element gate) {
    final IndexedStack stack = tester.widget<IndexedStack>(
      find
