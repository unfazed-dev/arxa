...
import 'package:appbox_kit_ui_library/widgets/appbox_kit_native_popup_menu.dart';

import 'appbox_kit_native_test_helpers.dart';

/// Native-widget tests for [AppBoxKitNativePopupMenu]. Two tiers:
///
...
void main() {
  ...
  testWidgets(
    ...
    await tester.pumpWidget(
      host(const AppBoxKitNativePopupMenu(icon: Icons.more_vert, items: items)),
    );
    ...
    await tester.tap(find.byType(AppBoxKitNativePopupMenu));
    await tester.pumpAndSettle();

    expect(
      find.byType(PopupMenuItem<AppBoxKitMenuItem>),
      findsWidgets,
  ...
  testWidgets(
    ...
    await withAndroidFallback(() async {
      await tester.pumpWidget(
        host(const AppBoxKitNativePopupMenu(
  ...
  testWidgets(
    ...
    await withAndroidFallback(() async {
      await tester.pumpWidget(
        host(const AppBoxKitNativePopupMenu(label: 'Actions', items: items)),
      );
