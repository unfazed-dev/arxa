...
/// [ArxaKitNativeTextField] keyboard-dismissal behavior tests — the per-input
  ...
  testWidgets(
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        ...
        bottomSheet: ArxaKitNativeInputBar(
          hintText: 'Message',
          wantNative: false,
          onSubmitted: (_) {},
        ),
    ...
    expect(barField.hasPrimaryFocus, isFalse,
        reason: 'the input bar composes ArxaKitNativeTextField, so it '
