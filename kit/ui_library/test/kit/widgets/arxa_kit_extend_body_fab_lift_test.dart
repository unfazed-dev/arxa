...
import 'package:arxa_kit_ui_library/widgets/arxa_kit_bottom_nav_scaffold.dart';
...
void main() {
  ...
  // ArxaKitExtendBodyFabLift mirrors padding into viewPadding so the FAB clears it.
  testWidgets(
      'kit.ui-library.extend-body-fab-lift — nested-scaffold FAB floats clear of the extendBody bar',
      (tester) async {
