...
import 'package:appbox_kit_ui_library/widgets/appbox_kit_native_sliver_app_bar.dart';
...
void main() {
      ...
      MaterialApp(
        home: Scaffold(
          body: CustomScrollView(
            slivers: const [
              AppBoxKitNativeSliverAppBar(title: 'Folders'),
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: CustomScrollView(
            slivers: [
              const AppBoxKitNativeSliverAppBar(title: 'T', wantNative: false),
  ...
  // screen edge — visibly tighter than the fixed AppBoxKitNativeAppBar
          ...
          builder: (context) => TextButton(
            onPressed: () => Navigator.of(context).push(MaterialPageRoute<void>(
              builder: (_) => const Scaffold(
                body: CustomScrollView(
                  slivers: [
                    AppBoxKitNativeSliverAppBar(title: 'Detail'),
                    SliverFillRemaining(child: SizedBox.shrink()),
                  ],
                ),
              ),
