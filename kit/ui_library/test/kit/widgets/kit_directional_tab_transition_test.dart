...
import 'package:ui_library/widgets/kit_directional_tab_transition.dart';

// The child handed to KitDirectionalTabTransition is an IndexedStack that
...
void main() {
  ...
  testWidgets('retains the tabs-stack element across tab switches',
    ...
    Widget frame(int index) => Directionality(
          ...
          child: KitDirectionalTabTransition(
            activeIndex: index,
