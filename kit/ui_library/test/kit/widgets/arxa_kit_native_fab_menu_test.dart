...
import 'package:arxa_kit_ui_library/widgets/arxa_kit_native_fab_menu.dart';

import 'arxa_kit_native_test_helpers.dart';

/// Native-widget tests for [ArxaKitNativeFabMenu]. Two tiers:
///
...
void main() {
  ...
  const items = [
    ...
    ArxaKitMenuItem(label: 'Delete', sfSymbol: 'trash', isDestructive: true),
  ];
  ...
  testWidgets('kit.ui-library.native-fab-menu — Android routes to FabMenuM3E',
    ...
    await tester.pumpWidget(
      host(const ArxaKitNativeFabMenu(icon: Icons.add, items: items)),
    );
