...
import 'package:arxa_kit_ui_library/widgets/arxa_kit_opaque_bar_base.dart';
import 'package:arxa_kit_ui_library/widgets/arxa_kit_frosted_surface.dart';

/// [ArxaKitOpaqueBarBase] — the opaque pinned-strip base extracted from
/// [ArxaKitNativeInputBar] so any strip docked above/around pinned chrome
...
void main() {
  testWidgets(
    ...
    await tester.pumpWidget(const MaterialApp(
      home: Scaffold(
        body: Align(alignment: Alignment.bottomCenter, child: ArxaKitOpaqueBarBase(child: SizedBox(width: 100, height: 40, child: Text('x')))),
      ),
    ));

    final surface = tester.widget<ArxaKitFrostedSurface>(
