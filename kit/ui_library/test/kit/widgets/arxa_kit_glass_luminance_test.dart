...
/// site. Surfaces publish their luminance through [ArxaKitGlassLuminance]
/// (ArxaKitFrostedSurface's opaque branch, the opaque bar base, sheet and
...
void main() {
  ...
  Widget brightOpaqueScope(Widget child) => ArxaKitGlassLuminance(
  ...
  testWidgets(
      ...
      (tester) async {
    await tester.pumpWidget(host(brightOpaqueScope(ArxaKitNativeButton(
      label: 'Continue',
      sfSymbol: 'star',
      onPressed: () {},
    ))));
  ...
  testWidgets(
      ...
      (tester) async {
    await tester.pumpWidget(host(ArxaKitGlassLuminance(
      opaque: true,
      brightness: Brightness.dark,
      child: ArxaKitNativeButton(label: 'Continue', onPressed: () {}),
    )));
  ...
  testWidgets(
    ...
    await tester.pumpWidget(
        host(ArxaKitNativeButton(label: 'Continue', onPressed: () {})));
  ...
  testWidgets(
    ...
    await tester.pumpWidget(host(brightOpaqueScope(
        ArxaKitNativeIconButton(icon: Icons.add, onPressed: () {}))));
  ...
  testWidgets(
      ...
      (tester) async {
    await tester.pumpWidget(host(brightOpaqueScope(ArxaKitNativeIconButton(
