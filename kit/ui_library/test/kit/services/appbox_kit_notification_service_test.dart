...
/// AppBoxKitNotificationService tests.
///
...
///   [SnackbarService]; a recording stub is registered in [appBoxKitLocator] and we
...
void main() {
  ...
  setUp(() => service = AppBoxKitNotificationService());
  ...
  testWidgets(
    ...
    expect(
      ...
      reason: 'AppBoxKitNotificationKind.success maps to the success variant',
    );
  ...
  testWidgets(
    ...
    expect(svc.lastVariant, AppBoxKitSnackbarType.appBoxKitAutoProcessError);
