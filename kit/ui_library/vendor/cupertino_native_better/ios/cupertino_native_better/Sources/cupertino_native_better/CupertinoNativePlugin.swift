...
public class CupertinoNativePlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    let rangeSliderFactory = CupertinoRangeSliderViewFactory(messenger: registrar.messenger())
    registrar.register(rangeSliderFactory, withId: "CupertinoNativeRangeSlider")
    ...
    // Text field (Liquid Glass on iOS 26+, systemGray6 capsule below)
    let textFieldFactory = CupertinoTextFieldFactory(messenger: registrar.messenger())
    registrar.register(textFieldFactory, withId: "CNTextField")
