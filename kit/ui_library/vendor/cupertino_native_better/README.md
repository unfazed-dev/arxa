...
| `CNToast` | Toast notifications; glass tier available on iOS 26+ (`useGlassEffect: true`) — the arxa kit pins `useGlassEffect: false` on every kind (Flutter-drawn, arxa allowlist rule 12) | - |
