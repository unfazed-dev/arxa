...
/// [ArxaKitGlassCard]'s native tier mounts).
///
/// Wrap the app's shell root ONCE:
///
/// ```dart
/// ArxaKitGlassWarmup(child: shellScaffold)
/// ```
///
/// Mechanics:
...
class ArxaKitGlassWarmup extends StatelessWidget {
  const ArxaKitGlassWarmup({
    super.key,
    required this.child,
  ...
  Widget build(BuildContext context) {
    if (!ArxaKitPlatform.supportsLiquidGlass) return child;
    return Stack(
