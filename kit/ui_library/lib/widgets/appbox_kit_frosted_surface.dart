...
class AppBoxKitFrostedSurface extends StatelessWidget {
  const AppBoxKitFrostedSurface({
    super.key,
    required this.child,
    this.padding,
  ...
  /// caller owns spacing (matches [AppBoxKitGlassCard], which pads before handing
  /// its content down).
