...
class ArxaKitNativeLoadingIndicator extends StatelessWidget {
  const ArxaKitNativeLoadingIndicator({super.key, this.size, this.color});
  ...
  Widget build(BuildContext context) {
    ...
    if (ArxaKitPlatform.isIOS) return _cupertino(context);
