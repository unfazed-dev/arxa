...
/// SF Symbol from [ArxaKitGlyphs]) + [isDestructive] — so hosts never import the
/// underlying menu deps. Mirrors [ArxaKitTab]'s shape: the kit owns the
...
class ArxaKitMenuItem {
  ...
  @override
  String toString() =>
      'ArxaKitMenuItem(label: $label, sfSymbol: $sfSymbol, icon: $icon, '
