...
class ArxaKitTab {
  const ArxaKitTab({
    ...
    String? sfSymbol,
            ...
            'ArxaKitTab needs a glyph or an icon'),
        _icon = icon,
        _sfSymbol = sfSymbol;
...
class ArxaKitNativeTabBar extends StatelessWidget {
  const ArxaKitNativeTabBar({
    super.key,
    required this.tabs,
  ...
  Widget build(BuildContext context) {
    ...
    if (wantNative && ArxaKitPlatform.supportsLiquidGlass) {
      ...
      // `CNTabBarRouteObserver`.  Our `arxaKitWithNativeChromeHidden` helper bumps
      ...
      //
      // Fix: ArxaKitNativeChromeGate hides the bar on `anyModalDepth` at the
