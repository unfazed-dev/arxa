...
/// [ArxaKitNativeIconButton] (search / app bar): same motion token
...
class ArxaKitFabMorph extends StatelessWidget {
  const ArxaKitFabMorph({super.key, required this.icon, this.onPressed});
  ...
  Widget build(BuildContext context) {
    ...
    return IconButton(
      ...
      style: ButtonStyle(
        ...
        // Animate the pressed shape morph — matches ArxaKitNativeIconButton.
