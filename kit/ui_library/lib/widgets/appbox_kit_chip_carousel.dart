...
/// A horizontal rail of chips (usually `AppBoxKitChip`s) — edge-faded when the
...
/// chip-rail surface to wrap, so this widget is named `AppBoxKitChipCarousel` (a
/// content widget), **not** `AppBoxKitNativeChipCarousel`. See
...
///   default.
class AppBoxKitChipCarousel extends StatefulWidget {
  ...
  @override
  State<AppBoxKitChipCarousel> createState() => _KitChipCarouselState();
}

class _KitChipCarouselState extends State<AppBoxKitChipCarousel> {
  ...
  @override
  void didUpdateWidget(AppBoxKitChipCarousel oldWidget) {
