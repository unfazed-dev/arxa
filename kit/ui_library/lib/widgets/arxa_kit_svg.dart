...
///
/// [ArxaKitSvg.asset] renders a bundled asset; [ArxaKitSvg.network] fetches one.
/// [color] tints the whole drawing (`BlendMode.srcIn`) — the common
/// "icon takes the theme color" case.
class ArxaKitSvg extends StatelessWidget {
  const ArxaKitSvg.asset(
    String asset, {
    super.key,
    this.width,
    this.height,
