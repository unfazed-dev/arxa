...
/// content widgets ([AppBoxKitListTile], [AppBoxKitChip]) and app rows use it
...
/// replaces.
class AppBoxKitPressable extends StatefulWidget {
  const AppBoxKitPressable({
    super.key,
    required this.child,
    this.onTap,
    this.onLongPress,
  ...
  @override
  State<AppBoxKitPressable> createState() => _AppBoxKitPressableState();
}

class _AppBoxKitPressableState extends State<AppBoxKitPressable> {
  bool _pressed = false;
