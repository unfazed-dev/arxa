...
// `arxa_kit_native_chrome_gate_test.dart`, which toggles a gate five times and
...
class ArxaKitLazyIndexedStack extends StatefulWidget {
  const ArxaKitLazyIndexedStack({
    super.key,
    required this.index,
  ...
  @override
  State<ArxaKitLazyIndexedStack> createState() => _KitLazyIndexedStackState();
}

class _KitLazyIndexedStackState extends State<ArxaKitLazyIndexedStack> {
  ...
  @override
  void didUpdateWidget(covariant ArxaKitLazyIndexedStack oldWidget) {
