...
/// [KitNativeSlider]'s thumb beside it. UIKit has no two-thumb slider, so the
...
class KitNativeRangeSlider extends StatelessWidget {
  const KitNativeRangeSlider({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    if (KitPlatform.isIOS) return _cupertinoStyled(context);
    return RangeSlider(
      values: values,
      onChanged: onChanged,
      min: min,
