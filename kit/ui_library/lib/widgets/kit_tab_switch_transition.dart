...
/// [KitDirectionalTabTransition] for setups WITHOUT a tabs-router animation —
...
///
/// **Superseded by [KitAnimatedTabStack] for kept-alive tab stacks.** This
/// widget receives the ALREADY-SWAPPED stack, so it animates only the incoming
/// tab — the outgoing one vanishes with the index swap. [KitAnimatedTabStack]
...
/// that mount platform views (`KitNative*` / UiKitView chrome). Opacity-animating
...
class KitTabSwitchTransition extends StatefulWidget {
  ...
  @override
  State<KitTabSwitchTransition> createState() => _KitTabSwitchTransitionState();
}

class _KitTabSwitchTransitionState extends State<KitTabSwitchTransition>
  ...
  @override
  void didUpdateWidget(KitTabSwitchTransition oldWidget) {
