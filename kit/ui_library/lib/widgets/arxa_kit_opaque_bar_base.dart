...
/// [ArxaKitNativeInputBar] (its `opaqueGlass` backing) so strips docked
...
///
/// 1. [ArxaKitFrostedSurface] with `platformViewSafe: true` and the tint
...
/// not knobs.
class ArxaKitOpaqueBarBase extends StatelessWidget {
  const ArxaKitOpaqueBarBase({super.key, required this.child});
