...
/// Material IconData would shadow the native SF Symbol). Mirrors [KitTab]'s
/// `sfSymbol` so the host passes a plain string and stays free of the dep.
class KitNativeButton extends StatelessWidget {
  const KitNativeButton({
    super.key,
    ...
    this.sfSymbolColor,
    this.style = KitButtonStyle.glass,
  ...
  static const _m3eStyle = <KitButtonStyle, ButtonM3EStyle>{
    KitButtonStyle.plain: ButtonM3EStyle.text,
    KitButtonStyle.gray: ButtonM3EStyle.tonal,
    KitButtonStyle.tinted: ButtonM3EStyle.tonal,
    KitButtonStyle.bordered: ButtonM3EStyle.outlined,
    KitButtonStyle.borderedProminent: ButtonM3EStyle.filled,
    KitButtonStyle.filled: ButtonM3EStyle.filled,
    KitButtonStyle.glass: ButtonM3EStyle.tonal,
    KitButtonStyle.prominentGlass: ButtonM3EStyle.filled,
  };
