...
/// Adaptive text field — three-tier, matching the rest of the `KitNative*`
...
class KitNativeTextField extends StatelessWidget {
  const KitNativeTextField({
    super.key,
    this.controller,
    this.placeholder,
    this.hintText,
  ...
  /// for symmetry with [KitNativeSearchBar.hint].
  ...
  Widget build(BuildContext context) {
    ...
    final useNativeTier =
        wantNative && (KitPlatform.isIOS || KitPlatform.isDesktop);
    if (useNativeTier) {
    ...
    // like every KitNative* sibling. `wantNative: false` skips it to the
