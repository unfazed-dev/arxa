...
import 'arxa_kit_native_loading_indicator.dart';
...
/// bind facade/viewmodel streams with [ArxaKitStreamBuilder] and never render
...
/// - **[ArxaKitStreamBuilder]** — displaying one or more kit-data streams in a
...
class ArxaKitStreamBuilder<T> extends StatelessWidget {
  const ArxaKitStreamBuilder({
    super.key,
