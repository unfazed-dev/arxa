...
/// Mirrors [KitNativeButton]'s icon convention so the host passes primitives and
/// stays free of the dep.
///
/// [onPressed] is nullable: `null` disables the button on both tiers.
class KitNativeIconButton extends StatelessWidget {
  const KitNativeIconButton({
    super.key,
    this.glyph,
    IconData? icon,
    String? sfSymbol,
  ...
  /// [KitNativeToolbar]'s 18pt symbols) and the M3E Icon default (24) on
  /// Android.
  final double? size;
...
/// Shared implied leading for the kit app bars ([KitNativeAppBar] +
/// [KitNativeSliverAppBar]). When the host passed no [leading] and the route
...
/// [KitNativeIconButton] with [KitGlyphs.back] — the SAME widget the trailing
...
Widget? kitImpliedAppBarLeading(
