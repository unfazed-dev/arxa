...
/// [ArxaKitFrostedSurface]'s backdrop filter has real content to blur (ADR
...
Future<T?> arxaKitShowSheet<T>({
  ...
  // modal-aware native widget ([ArxaKitNativeChromeGate],
  // [ArxaKitScrollOcclusionGate], `CNSearchBar`'s self-hide) reacting even
...
class _CupertinoSheetBody extends StatelessWidget {
  ...
  Widget _surface(Widget content) {
    ...
    return ArxaKitFrostedSurface(borderRadius: 0, blur: 30, child: content);
  }
}
...
class _SheetGrabber extends StatelessWidget {
  ...
  static const Key grabberKey = Key('arxa_kit_sheet_grabber');
