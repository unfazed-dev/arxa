...
/// Adaptive search bar — two-way structural gate (mirrors [ArxaKitNativeTabBar]'s
...
class ArxaKitNativeSearchBar extends StatelessWidget {
  const ArxaKitNativeSearchBar({
    super.key,
    this.hint,
    this.controller,
    this.onChanged,
  ...
  Widget build(BuildContext context) {
    final isCN = wantNative &&
        ArxaKitPlatform.supportsLiquidGlass &&
        !ArxaKitPlatform.supportsComposeM3E;
    ...
    if (actionLabel == null || onAction == null) {
      return ArxaKitInputTapBehavior(child: field);
    }
    return ArxaKitInputTapBehavior(
      child: Row(
        spacing: abxGap8,
        children: [
