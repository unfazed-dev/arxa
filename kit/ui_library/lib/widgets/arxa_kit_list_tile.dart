...
/// `ArxaKitListTile` (a content widget), **not** `ArxaKitNativeListTile`. See
...
/// [ArxaKitGlassCard]-backed `ArxaKitListSection` (which owns the group container,
/// header, and dividers) or inside any card surface directly. The row keeps a
/// minimum height of [abxSize48] and presses via [ArxaKitPressable] (a dim,
...
class ArxaKitListTile extends StatelessWidget {
  ...
  /// Whether to append a [ArxaKitGlyphs.chevronRight] affordance at the trailing
  ...
  Widget build(BuildContext context) {
    ...
    // splash paints over the glass tiers (see ArxaKitPressable).
    return ArxaKitPressable(onTap: onTap, child: row);
  }
}
