...
/// Material IconData would shadow the native SF Symbol). Mirrors [ArxaKitTab]'s
/// `sfSymbol` so the host passes a plain string and stays free of the dep.
class ArxaKitNativeButton extends StatelessWidget {
  const ArxaKitNativeButton({
    super.key,
    ...
    this.sfSymbolColor,
    this.style = ArxaKitButtonStyle.glass,
  ...
  final ArxaKitButtonStyle style;
  ...
  /// [ArxaKitGlassLuminance] scope or, absent one, the theme's scaffold
  /// background — the plain [ArxaKitButtonStyle.glass] style demotes to
  ...
  Widget build(BuildContext context) {
    ...
    final demote = luminanceAdaptive &&
        ...
        arxaKitGlassDemotesOnBrightBase(context);
    ...
    return CNButton(
      ...
      config: CNButtonConfig(
        ...
        style: CNButtonStyle.values
            .byName((demote ? ArxaKitButtonStyle.gray : style).name),
  ...
  static const _m3eStyle = <ArxaKitButtonStyle, ButtonM3EStyle>{
    ArxaKitButtonStyle.plain: ButtonM3EStyle.text,
    ArxaKitButtonStyle.gray: ButtonM3EStyle.tonal,
    ArxaKitButtonStyle.tinted: ButtonM3EStyle.tonal,
    ArxaKitButtonStyle.bordered: ButtonM3EStyle.outlined,
    ArxaKitButtonStyle.borderedProminent: ButtonM3EStyle.filled,
    ArxaKitButtonStyle.filled: ButtonM3EStyle.filled,
    ArxaKitButtonStyle.glass: ButtonM3EStyle.tonal,
    ArxaKitButtonStyle.prominentGlass: ButtonM3EStyle.filled,
  };
