...
import 'appbox_kit_native_loading_indicator.dart';
...
/// bind facade/viewmodel streams with [AppBoxKitStreamBuilder] and never render
...
/// - **[AppBoxKitStreamBuilder]** — displaying one or more kit-data streams in a
...
class AppBoxKitStreamBuilder<T> extends StatelessWidget {
  const AppBoxKitStreamBuilder({
    super.key,
