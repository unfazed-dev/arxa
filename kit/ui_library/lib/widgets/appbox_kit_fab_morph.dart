...
/// [AppBoxKitNativeIconButton] (search / app bar): same motion token
...
class AppBoxKitFabMorph extends StatelessWidget {
  const AppBoxKitFabMorph({super.key, required this.icon, this.onPressed});
  ...
  Widget build(BuildContext context) {
    ...
    return IconButton(
      ...
      style: ButtonStyle(
        ...
        // Animate the pressed shape morph — matches AppBoxKitNativeIconButton.
