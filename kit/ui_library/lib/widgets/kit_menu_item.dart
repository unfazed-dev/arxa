...
/// SF Symbol from [KitGlyphs]) + [isDestructive] — so hosts never import the
/// underlying menu deps. Mirrors [KitTab]'s shape: the kit owns the
...
class KitMenuItem {
  ...
  @override
  String toString() =>
      'KitMenuItem(label: $label, sfSymbol: $sfSymbol, icon: $icon, '
