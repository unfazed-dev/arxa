...
/// [AppBoxKitNativeSlider]'s thumb beside it. UIKit has no two-thumb slider, so the
...
class AppBoxKitNativeRangeSlider extends StatelessWidget {
  const AppBoxKitNativeRangeSlider({
    super.key,
