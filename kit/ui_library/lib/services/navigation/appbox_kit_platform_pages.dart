...
///
/// Apply via [AppBoxKitPlatformPagesMixin] — see its docs.
class AppBoxKitPlatformPages {
  const AppBoxKitPlatformPages._();
...
/// page on iOS and a material page elsewhere (see [AppBoxKitPlatformPages] for why).
...
///
/// ```dart
/// class AppRouter extends StackedRouterWeb with AppBoxKitPlatformPagesMixin {
///   AppRouter({super.navigatorKey});
/// }
/// ```
mixin AppBoxKitPlatformPagesMixin on RootStackRouter {
  @override
  PageBuilder get pageBuilder => (RouteData data) =>
      AppBoxKitPlatformPages.platform(super.pageBuilder(data), data);
}
