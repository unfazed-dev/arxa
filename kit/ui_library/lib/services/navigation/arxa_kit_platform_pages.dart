...
///
/// Apply via [ArxaKitPlatformPagesMixin] — see its docs.
class ArxaKitPlatformPages {
  const ArxaKitPlatformPages._();
...
/// page on iOS and a material page elsewhere (see [ArxaKitPlatformPages] for why).
...
///
/// ```dart
/// class AppRouter extends StackedRouterWeb with ArxaKitPlatformPagesMixin {
///   AppRouter({super.navigatorKey});
/// }
/// ```
mixin ArxaKitPlatformPagesMixin on RootStackRouter {
  @override
  PageBuilder get pageBuilder => (RouteData data) =>
      ArxaKitPlatformPages.platform(super.pageBuilder(data), data);
}
