...
/// Internal configuration class that stores all KitAction settings
/// Built up by KitActionBuilder and consumed by KitActionExecutor
class KitActionConfig<T> {
  ...
  NotificationType loadingNotificationType = NotificationType.snackbar;

  /// Type of notification for success state (snackbar, dialog, bottomSheet, none)
  NotificationType successNotificationType = NotificationType.snackbar;

  /// Type of notification for error state (snackbar, dialog, bottomSheet, none)
  NotificationType errorNotificationType = NotificationType.snackbar;
  ...
  /// Creates a new KitAction configuration
  KitActionConfig({
