// ═══════════════════════════════════════════════════════════════════════════════
// AppBoxKitAction v2.0 - Notification Type Enum
// ═══════════════════════════════════════════════════════════════════════════════
//
...
///
/// AppBoxKitAction supports multiple notification types for loading, success, and error states:
...
enum AppBoxKitNotificationType {
