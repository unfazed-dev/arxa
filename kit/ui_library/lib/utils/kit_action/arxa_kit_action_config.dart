...
/// Internal configuration class that stores all ArxaKitAction settings
/// Built up by ArxaKitActionBuilder and consumed by ArxaKitActionExecutor
class ArxaKitActionConfig<T> {
  ...
  /// throws ArxaKitGuardedException. Debounced chains are exempt by nature (a newer
  ...
  /// Creates a new ArxaKitAction configuration
  ArxaKitActionConfig({
