...
class ArxaKitRecordingResult {
  const ArxaKitRecordingResult({required this.path, required this.duration});
...
abstract class ArxaKitAudioRecorderService {
  ...
  /// captured.
  Future<ArxaKitRecordingResult?> stop();
...
/// [ArxaKitAudioRecorderService] backed by the native `record` plugin.
class ArxaKitRecordAudioRecorderService implements ArxaKitAudioRecorderService {
  ArxaKitRecordAudioRecorderService([AudioRecorder? recorder])
  ...
  Future<ArxaKitRecordingResult?> stop() async {
    ...
    return ArxaKitRecordingResult(path: path, duration: elapsed);
  }
