...
import 'arxa_kit_playback_state.dart';
...
abstract class ArxaKitAudioPlayerService {
...
/// [ArxaKitAudioPlayerService] backed by the native `just_audio` plugin.
class ArxaKitJustAudioPlayerService implements ArxaKitAudioPlayerService {
  ArxaKitJustAudioPlayerService([AudioPlayer? player])
  ...
  @override
  Stream<ArxaKitPlaybackState> get state$ => _player.playerStateStream.map(_toState);
  ...
  static ArxaKitPlaybackState _toState(PlayerState s) => ArxaKitPlaybackState(
        playing: s.playing,
        processing: switch (s.processingState) {
          ProcessingState.idle => ArxaKitMediaProcessingState.idle,
          ProcessingState.loading => ArxaKitMediaProcessingState.loading,
          ProcessingState.buffering => ArxaKitMediaProcessingState.buffering,
          ProcessingState.ready => ArxaKitMediaProcessingState.ready,
          ProcessingState.completed => ArxaKitMediaProcessingState.completed,
        },
      );
}
