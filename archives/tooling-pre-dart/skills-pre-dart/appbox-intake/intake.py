#!/usr/bin/env python3
"""appbox-intake — the elicitation engine.
...
ROOT = Path(__file__).resolve().parents[2]  # skills/appbox-intake/ -> repo root
...
def seed_from_brief(md: str) -> list[dict]:
    ...
    for line in lines:
        ...
        # appbox-story-mapper emits `priority` / `release` rollups this way.
