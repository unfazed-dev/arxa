// Role: the freeze design surface at the compact rung. Run-invariant by the
...
// History: git log --follow -- ui/views/studio_design_shell/studio_design_freeze/studio_design_freeze_view.mobile.tsx
