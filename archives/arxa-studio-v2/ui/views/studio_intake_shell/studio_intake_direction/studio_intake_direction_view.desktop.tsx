// Role: the direction step surface at the expanded rung. The step stages are
...
// History: git log --follow -- ui/views/studio_intake_shell/studio_intake_direction/studio_intake_direction_view.desktop.tsx
