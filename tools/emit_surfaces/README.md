...
This directory held only a one-line placeholder README from the plan-03 era;
nothing in the repo ever referenced it. Kept as a pointer so plan-doc
references to "emit_surfaces" resolve somewhere honest.
