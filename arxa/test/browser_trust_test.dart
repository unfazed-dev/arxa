...
import 'package:arxa/design_server.dart' show readTrustedOriginsFile;
...
void main() {
  ...
  group('frameAncestors — who may iframe us', () {
    ...
    test('never emits a bracketed IPv6 literal — CSP cannot express one', () {
      ...
      // An operator who puts one in ~/.arxa/trusted-origins is NOT
  ...
  group('~/.arxa/trusted-origins — the operator-level allowlist', () {
    late Directory home;

    setUp(() {
      home = Directory.systemTemp.createTempSync('arxa-home-');
      // Never the operator's real ~/.arxa: this test writes here.
