...
void main() {
  ...
  setUp(() async {
    fixture = Directory.systemTemp.createTempSync('arxa_test_');
    // Web root fixture.
    Directory('${fixture.path}/web').createSync();
    File('${fixture.path}/web/index.html')
        .writeAsStringSync('<h1>arxa</h1>');
  ...
  test('GET /api/memory/briefing returns the markdown briefing', () async {
    ...
    expect(response.statusCode, HttpStatus.ok);
    expect(response.headers.contentType.toString(), contains('text/markdown'));
    expect(body, contains('# arxa operator briefing'));
