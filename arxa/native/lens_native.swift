// lens_native — arxa lens macOS helper: ScreenCaptureKit one-shot capture +
// Vision OCR. Single file, no packages. Compiled on demand by
// lib/lens/native/sck.dart (ensureLensNativeBinary) into
// .dart_tool/arxa/lens_native and driven through the ProcessRunner seam.
//
// Usage:
...
// fail if the terminal lacks the grant. Plan: arxa-lens-full-port.md, Task 10.
