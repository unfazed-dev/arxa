...
import 'package:arxa/lens/native/adb.dart' show LensNativeException;
import 'package:arxa/lens/native/flutter_vm.dart';
import 'package:arxa/lens/native/sck.dart';

/// The design-vs-built visual gate.
///
/// Reads a `lens` block from `config/arxa.config.json`; absent →
...
// ── self-test (`arxa gate lens --self-test`) ─────────────────────────────
...
void _writeSelfTestConfig(String repoRoot, String baseUrl) {
  ...
  File('$repoRoot/config/arxa.config.json')
