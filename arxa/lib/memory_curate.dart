...
/// per-stage lesson logs. arxa owns this tree — arxa kit's `memory/` is
/// the template, never a dependency (docs/plans/arxa-memory-and-payment.md,
/// M1).
///
/// Write-path doctrine: raw events are appended by deterministic writers
/// (gates, runner, gateway) to the arxa data dir; curated lessons are
