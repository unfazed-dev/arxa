...
// and extend an arxa kit WITHOUT reading its source. Mechanical sections
...
// prose pass.
//
// Branding: packages are `arxa_kit_*` (the facts `name`). The Stacked MVVM
...
///   - `name` (e.g. "arxa_kit_core"), `version`, `description`, `readmeFirst`
///   - `hasTesting` (bool)
...
String generatePlaybook(Map<String, dynamic> facts) {
  final name = (facts['name'] as String?) ?? 'arxa_kit';
...
/// Short id slug for a kit: `arxa_kit_core` -> `core`.
String _slug(String name) {
  const prefix = 'arxa_kit_';
