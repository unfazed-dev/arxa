...
//
// Branding: the Python source emitted "stacked_kit"; this port emits "arxa kit".
...
///
/// [repoRoot] is the arxa root. Reads `kb/sources.json` and
...
///
/// [repoRoot] is the arxa root. Reads `memory/facts/*.json`; writes
...
void _buildIndex(String kbDir, List<Source> srcs, Map<String, Fact> facts) {
  ...
  final body = <String>[
    '# arxa kit knowledge base',
    '',
    'Curated arxa kit / Flutter / Dart documentation, MCP servers, and per-kit',
...
String _buildPlaybooksMd(Map<String, Fact> facts) {
  ...
  lines.addAll([
    ...
    '## Knowledge base',
    '',
    '- [kb/KB.md](kb/KB.md) — curated arxa kit/Flutter/Dart docs + MCP servers + per-kit package refs',
...
String _buildLlmsTxt(Map<String, Fact> facts) {
  final lines = <String>[
    '# arxa kit',
    '',
    '> A curated set of standalone capability kits for Flutter apps on the arxa kit '
