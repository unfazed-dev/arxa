// story_map_cli — `arxa emit story-map` entry module.
//
// Exposes [storyMapMain], the callable the dispatcher in bin/arxa.dart routes
...
import 'package:arxa/intake.dart' show repoRoot, validateIntake;
import 'package:arxa/story_map.dart';

const _usage = '''
Usage: arxa emit story-map [options]
...
/// Entry point for `arxa emit story-map`. Returns the process exit code.
...
int _usageErr(String msg) {
  stderr.writeln('arxa emit story-map: $msg');
  stderr.write(_usage);
  return 64;
}
