...
//   are authored by arxa-story-mapper and arxa-moodboarder; intake is only
...
/// Emit `map.json` from the optional `map` answer group — arxa-story-mapper's
...
///     methodology ("docs/moodboards · arxa lens captures · every shot
...
/// 2 decimals — never trusted from the seed, so `arxa moodboard check`
