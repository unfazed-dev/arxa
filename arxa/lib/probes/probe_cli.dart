// `arxa design probe <names…|all>` — the design-probe dispatcher.
//
...
String _usage() {
  final rows = kProbes
      ...
      .join('\n');
  return '''
Usage: arxa design probe <suite|name…|all> [--port <n> | --base <url>] [--project <name>]

Suites:
  contract          Asserts the arxa opinion against ANY served design,
...
Target (exactly one of --port/--base; ARXA_BASE is the fallback):
...
/// Entry point for `arxa design probe`. Returns the process exit code.
