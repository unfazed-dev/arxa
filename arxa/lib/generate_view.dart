...
const Map<String, List<String>> iconMap = {
  'play': ["ArxaKitGlyphs.lucide('play')", 'play.fill'],
  'pause': ["ArxaKitGlyphs.lucide('pause')", 'pause.fill'],
  'reset': ["ArxaKitGlyphs.lucide('refresh-cw')", 'arrow.clockwise'],
  'back': ["ArxaKitGlyphs.lucide('chevron-left')", 'chevron.left'],
  'chevron-left': ["ArxaKitGlyphs.lucide('chevron-left')", 'chevron.left'],
  'chevron-right': ["ArxaKitGlyphs.lucide('chevron-right')", 'chevron.right'],
  'chevron': ["ArxaKitGlyphs.lucide('chevron-right')", 'chevron.right'],
  'edit': ["ArxaKitGlyphs.lucide('pencil')", 'pencil'],
  'check': ["ArxaKitGlyphs.lucide('check')", 'checkmark'],
  'sound': ["ArxaKitGlyphs.lucide('volume-2')", 'speaker.wave.2.fill'],
  'close': ["ArxaKitGlyphs.lucide('x')", 'xmark'],
  'plus': ["ArxaKitGlyphs.lucide('plus')", 'plus'],
};

const List<String> defaultIcon = ["ArxaKitGlyphs.lucide('circle')", 'circle'];
...
// @arxa-extension-point: presentation/${snake}_viewmodel
...
// add logic. @arxa-extension-point: presentation/${snake}_viewmodel
import '${snake}_viewmodel.gen.dart';
...
bool stubIsDefault(String text) {
  if (!text.contains('@arxa-extension-point')) return false;
...
String tplHomeAssetsStub(Map<String, dynamic> symbols) {
  ...
  return '// FACTORY EXTENSION POINT — hand-edit freely; the factory will NOT overwrite this\n'
      '// file once you add real chart painters. @arxa-extension-point: presentation/home_assets\n'
      '//\n'
...
class GenerateView {
  ...
  String emitImpl(Node node, bool sess) {
    ...
    if (prim == 'IconButton') {
      return "AdaptiveIconButton(icon: ArxaKitGlyphs.lucide('play'), sfSymbol: 'play.fill', "
