...
// arxa_kit producer runs the full C1–C5 set over lib/ui/views.
...
GateResult coverageGate(GateContext ctx) {
  ...
  // which points at the repo's own designs/arxa-studio-v2). Fail-open only on an empty
  ...
  // ---- arxa_kit producer: full C1–C5 over lib/ui/views ----
