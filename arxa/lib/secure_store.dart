/// Encryption-at-rest for arxa's own sensitive state (plan P1): vault
...
/// 2. Passphrase via PBKDF2-HMAC-SHA256 — env `ARXA_PASSPHRASE` for
///    headless hosts with no vault backend. The passphrase key is derived
///    with a fixed application salt (`arxa.state.v1`): acceptable for the
...
/// ARXA_PASSPHRASE or state stays unwritable; that is the intended
/// behaviour, not a gap.)
library;
