// arxa memory — project-scoped memory verbs (arxa H5, engine side).
//
//   arxa memory add    --project <dir> --topic <t> --source <stage> "fact"
//   arxa memory recall --project <dir> [--topic <t>] [--grep <q>]
//   arxa memory why    --project <dir> <topic> <index>
//
...
//
// Write-path doctrine (arxa-memory-and-payment.md M1): every fact carries a
...
const _usage = '''
usage: arxa memory <verb> [options]
...
int _fail(String msg) {
  stderr.writeln('arxa memory: $msg');
  return 64;
}
