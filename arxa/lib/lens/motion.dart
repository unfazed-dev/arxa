// Motion capture for the arxa lens: burst stills, screencast→mp4 record,
...
Future<void> framesToMp4(
  ...
  final tmp = await Directory.systemTemp.createTemp('arxa-motion-');
  try {
...
Future<Map<String, dynamic>> captureFlipbook(
  ...
  try {
    ...
    // kimitail: WAAPI covers arxa's own designs; when a design animates
