// arxa-lens — native adb capture verbs.
//
// Ports the capture-relevant adb verbs to the arxa lens. Thin ProcessRunner
...
//
// Plan: arxa-lens-full-port.md, Task 8.
...
///
/// Serial resolution order: an explicit [serial] > `$ARXA_ADB_SERIAL`
...
class LensAdb {
  LensAdb({String? serial, ProcessRunner? runner, Map<String, String>? env})
      : _serial = serial ?? (env ?? Platform.environment)['ARXA_ADB_SERIAL'],
