// Gate framework — shared infrastructure for all arxa gates.
//
...
class GateContext {
  ...
  /// `~/.arxa/entitlement.jwt`). Same on-the-context rationale as [project];
...
/// Path: ARXA_STATE → pipeline/state/run.state.json → pipeline/state/default.state.json.
class StateReader {
